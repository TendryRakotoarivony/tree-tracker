...
# Subset on time
slice_start = (
    str(col_b.date_input("📅 From", value=datetime.date(2020, 8, 1))) + "T00"
)  # "2020-08-01T00"
...
col_2.metric(
    "🌧️ Precipitation (mm)", str(round(gb_prec["tp"].mean(), 4)), delta="", delta_color="normal"
)
col_3.metric(
    "🌪️ Evapotranspiration (mm/unit time)",
